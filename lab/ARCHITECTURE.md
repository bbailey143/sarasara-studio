...
This is a small CPU grid intended to expose behavior for review. It is not the production Rust/GPU solver. Spectral color, granulation, brush reservoirs, measured paper profiles, and artist-accepted clean-water blooms remain future work. The watercolor v0.6.1 patch preserves the accepted v0.6 material constants while paper physics now comes from an independent selected substrate. Charcoal v0.5 added mass-bounded coarse/fine fracture and dusting to the already accepted v0.4 loose-particle smudge motion; v0.5.1 increased shared fine-particle drag and settling after artist review found v0.5 too light, wispy, and nearly frictionless. The artist accepted v0.5.1's moderate smudge, then rejected its strong-pressure behavior because it swept material without leaving a pressed smear. v0.5.2 adds the shared high-load anchoring relationship and requires artist review at both moderate and strong settings. Fracture size shares, pressure anchoring, and travel/settling remain unmeasured stand-ins. Any new visible conclusion still requires artist approval.
