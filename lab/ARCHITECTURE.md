...
The paper selector preserves the archive's Plain White, Hot Press, Cold Press, and Rough Watercolor Paper seeds. The archive had no separately named charcoal/pastel sheet, and artist review rejected forcing its Rough watercolor preset into that role. Charcoal therefore defaults to an experimental Fine-Tooth Drawing Paper candidate with smaller, shallower tooth. It remains an independent `stand-in` substrate requiring artist approval. The old tooth, absorbency, sizing, capacity, breakup, seed, scale, and color values remain traceable on the archive seeds, while their canonical lab mapping is explicitly `archive-seed`, not measured truth. Substrate v0.2 corrects an initially inverted grain-scale mapping that made Rough look like zoomed-in terrain. Changing paper never changes the material profile or contact equations.
