(function(global){
  ...
  const SUBSTRATES={
    plain:{id:'substrate.paper.plain-white.archive-seed.v0.1',name:'Plain White',version:'0.1.0',state:{'TRAN-002':0,'SUBI-001':0,'SUBI-003':0},archive:{tooth:0,absorbency:0,sizing:1,capacity:0,dryBrushBreakup:0,seed:0,noiseScale:1,paperColor:'#ffffff'},provenance:[{status:'archive-seed',note:'Values preserved from the legacy Paper.plain preset; not measured production constants.'}]},
    hotPress:{id:'substrate.paper.hot-press.archive-seed.v0.1',name:'Hot Press',version:'0.1.0',state:{'TRAN-002':.026,'SUBI-001':.15,'SUBI-003':.4},archive:{tooth:.15,absorbency:.3,sizing:.8,capacity:.4,dryBrushBreakup:.15,seed:101,noiseScale:2,paperColor:'#fcfaf7'},provenance:[{status:'archive-seed',note:'Legacy preset values preserved; permeability is a normalized diagnostic mapping from absorbency and sizing, not a measurement.'}]},
    coldPress:{id:'substrate.paper.cold-press.archive-seed.v0.1',name:'Cold Press',version:'0.1.0',state:{'TRAN-002':.055,'SUBI-001':.5,'SUBI-003':.5},archive:{tooth:.5,absorbency:.5,sizing:.6,capacity:.5,dryBrushBreakup:.5,seed:42,noiseScale:1,paperColor:'#faf8f5'},provenance:[{status:'archive-seed',note:'Legacy preset values preserved; permeability is normalized to the previously reviewed diagnostic uptake rate.'}]},
    rough:{id:'substrate.paper.rough.archive-seed.v0.1',name:'Rough',version:'0.1.0',state:{'TRAN-002':.073,'SUBI-001':.85,'SUBI-003':.7},archive:{tooth:.85,absorbency:.6,sizing:.5,capacity:.7,dryBrushBreakup:.8,seed:7,noiseScale:.6,paperColor:'#f5f0e8'},provenance:[{status:'archive-seed',note:'Values preserved from the legacy Paper.rough preset; candidate for charcoal/pastel review, not final approval.'}]}
  };
  ...
  class SharedSolver{
    ...
    tooth(x,y){const a=this.substrate.archive,rough=this.s['SUBI-001'];if(rough<=0)return .5;let total=0,amplitude=.55,norm=0,frequency=Math.max(.025,a.noiseScale*.075);for(let octave=0;octave<4;octave++){total+=this.smoothNoise(x*frequency,y*frequency,a.seed+octave*7919)*amplitude;norm+=amplitude;amplitude*=.5;frequency*=2}const natural=total/norm,spread=.28+rough*.72;return Math.max(0,Math.min(1,.5+(natural-.5)*spread*1.65))}
