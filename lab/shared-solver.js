(function(global){
  ...
  const PROFILES={
    ...
    charcoal:{
      id:'material.charcoal.diagnostic.v0.5.2',version:'0.5.2',
      ...
      models:['MODEL-DEPO-001','MODEL-PART-001','MODEL-TRIB-001'],interactions:['IM-008','IM-009'],provenance:[{status:'stand-in',note:'Artist-recognizable diagnostic profile. Fracture toughness, abrasion resistance, coarse/fine shares, density, shape, and settling are normalized unmeasured stand-ins. v0.5.1 increased shared fine-particle drag and settling; v0.5.2 adds a shared high-load anchoring share so strong smudging presses part of relocated material into the paper instead of moving all of it as loose dust.'}]
    }
  };
