...
| --- | --- | --- | --- |
| CH-P-01 | Tooth capture | Light contact deposits on raised substrate regions before valleys. | `automated_relationship_verified` — on experimental Fine-Tooth Drawing Paper, matched light contact has greater average deposited mass in the raised height band than in the valley band. Artist review is pending. |
| CH-P-02 | Pressure progression | Increasing pressure progressively increases valley contact rather than scaling a fixed stamp. | `automated_relationship_verified` — matched firm contact increases average deposited mass in the Fine-Tooth valley band relative to light contact. Artist pressure progression is pending. |
...
The automated lab verifies that the charcoal profile deposits dry pigment, deposits no liquid carrier, and keeps pigment conservation error below 1%. CH-P-01 and CH-P-02 now isolate tooth-band capture and pressure-driven valley reach on the experimental Fine-Tooth Drawing Paper. CH-P-05 checks conservative relocation, post-contact momentum, and settling, and its v0.4 motion has limited artist acceptance. Artist Fine-Tooth/pressure review plus CH-P-03, CH-P-04, and CH-P-06 through CH-P-08 remain open. No final charcoal-medium acceptance is recorded.
