...
| --- | --- | --- | --- |
| CH-P-01 | Tooth capture | Light contact deposits on raised substrate regions before valleys. | `automated_relationship_verified` — on the archived Rough seed, matched light contact has greater average deposited mass in the raised height band than in the valley band. Artist paper comparison is pending. |
| CH-P-02 | Pressure progression | Increasing pressure progressively increases valley contact rather than scaling a fixed stamp. | `automated_relationship_verified` — matched firm contact increases average deposited mass in the Rough paper valley band relative to light contact. Artist pressure progression is pending. |
