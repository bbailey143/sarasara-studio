...
| WC-P-07 | Paper contrast | The same contact on smooth and porous substrates produces different uptake and spread. | `automated_relationship_verified` — matched wet contact on the archive-seeded Rough paper produces more absorbed carrier than Hot Press, while the selected paper remains independent from the watercolor material profile. Artist edge, uptake, and feel comparison is pending. |
